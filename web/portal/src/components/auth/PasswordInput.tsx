    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="relative">
        ...
        <button
          ...
          aria-pressed={reveal}
          className="absolute right-2 top-1/2 -translate-y-1/2 rounded p-2 text-text-muted hover:bg-bg-muted focus:outline-none focus:ring-2 focus:ring-primary-600/40"
        >
